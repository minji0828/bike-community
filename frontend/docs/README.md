...
These docs describe how the React Native app is structured and how it maps to the current backend APIs.

- `frontend/docs/overview.md`: product scope + MVP
- `frontend/docs/screens.md`: screen list and user flows
- `frontend/docs/api.md`: API mapping (request/response shapes)
